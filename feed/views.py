...
class NewsFeed(NewsDataMixin, Feed):
    ...
    description = "区块链导航, Block123.com 是汇集全网优质区块链项目网址及资源的中文上网导航。及时收录比特币 Bitcoin、比特币现金 Bitcoin Cash、莱特币 Litecoin、以太坊 Ethereum、经典以太币 Ethereum Classic 等区块链资产相关交易所、挖矿算力、当前交易价、交易数据统计及分析等分类的网址与内容，让你的区块链技术生活更简单直接。学习区块链，了解数字货币，从 Block123 开始。"
